 ...
 * @method static array<string, mixed>|false getRecordByField($field, $value, $cacheIndex = false)
 * @method static static|null getByWhere($conditions, $options = [])
 * @method static array<string, mixed>|false getRecordByWhere($conditions, $options = [])
